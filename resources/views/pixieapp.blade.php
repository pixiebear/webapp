...
<body id="home">
    ...
    height: 100%;position: absolute;width: 100%;z-index: 0;" class="rellax" data-rellax-speed="2"></div>

    <div style="background-image: url('/img/BGGreen.png');
        background-repeat-y: repeat;
height: 100%;position: absolute;width: 100%;z-index: 0;" class="rellax" data-rellax-speed="7">
                ...
                <div class="accordion" id="accordion2">
                    ...
                    <div class="accordion-group" data-aos="fade-up">
                        ...
                        <div id="collapseSeven" class="accordion-body collapse">
                            <div class="accordion-inner">
                                The minting price is gonna be 0.55 SOL per mint for WHITELISTED membears, and 0.7 for
                                PUBLIC sale.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-group" data-aos="fade-up">
                        ...
                        <div id="collapseThree" class="accordion-body collapse">
                            <div class="accordion-inner">
                                Bears should be free, not gated. But if we speak about secret access for OG Members.
                                Psst...It's coming !
                            </div>
                        </div>
                    </div>
