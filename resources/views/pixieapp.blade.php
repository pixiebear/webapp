...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 .c-button--distorted {
  ...
  <body id="home">
    ...
    height: 4000px;position: absolute;width: 100%;z-index: 0;" class="rellax" data-rellax-speed="-3"></div>

<div style="background-image: url('/img/BGYellow.png');
height: 4000px;position: absolute;width: 100%;z-index: 0;padding-top:600px;" class="rellax" data-rellax-speed="4"></div>
